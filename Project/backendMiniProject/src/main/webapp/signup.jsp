...
<body>
	<div id="wrapper">
		...
		<form class="container loginForm needs-validation"
			action="/backendMiniProject/signup.do" method="post" novalidate>
			...
			<div class="signUp">
				...
				<div class="row">
					...
					<div class="col">
						<label><input name="sex" type="radio" value="남자" />남자</label> <label><input
							name="sex" type="radio" value="여자" />여자</label>
					</div>
				</div>

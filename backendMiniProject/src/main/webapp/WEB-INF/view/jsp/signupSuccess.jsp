...
<body>
	<div id="wrapper">
		...
		<div class="container fixTop">
			...
			<div class="row">
				<div class="col-4">
					<a href="../../index.html"><img src="../image/logov2.png"
						style="width: 15em" /></a>
				</div>
				<!-- 검색 시작 -->
				...
				<div class="col mypage">
					<!-- 마이페이지 -->
					<a href="../../view/jsp/detailUserData.jsp"> <svg
                ...
                <path
					...
					<!-- 장바구니 -->
					<a href="../../view/jsp/basket.jsp"> <svg
							xmlns="http://www.w3.org/2000/svg" fill="currentColor"
			...
			<div class="row navbarPart">
				<div class="col-sm-6 col-md-9 navi">
					<ul>
						<li><a href="../../view/jsp/showProductList.jsp">BEST</a></li>
	...
	<footer class="footer-clean">
		<div class="container">
			<div class="row justify-content-center">
				...
				<div class="col-4 item">
					<p>
						상호: 땅이가나라다 주식회사<br /> 대표: 홍길동<br /> 주소: 서울특별시 강남구<br />

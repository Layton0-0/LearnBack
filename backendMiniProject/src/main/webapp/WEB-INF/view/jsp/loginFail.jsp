      ...
      <div class="container fixTop">
        ...
        <div class="row navbarPart">
          <div class="col-sm-6 col-md-9 navi">
            <ul>
              <li><a href="/showProductData.jsp">BEST</a></li>
              <li><a href="/showProductData.jsp">NEW</a></li>
              <li><a href="/showProductData.jsp">간식</a></li>
              <li><a href="/showProductData.jsp">건강</a></li>
              <li><a href="/showProductData.jsp">패션</a></li>
              <li><a href="/showProductData.jsp">기타</a></li>
            </ul>
          </div>
